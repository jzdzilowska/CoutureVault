...
//   console.log("Connected to MongoDB");
//    await createTextIndex(mongoClient, 'search-collection');
// });

// const nodeConnection = new NodeCollectionConnection(mongoClient);
// nodeConnection.establishConnection();

// const searchTerm = "hello";
// const searchResults = nodeConnection.searchNodes(searchTerm);
