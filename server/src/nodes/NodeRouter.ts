...
export class NodeRouter {
  ...
  constructor(mongoClient: MongoClient) {
    ...
    /**
     * Request to search nodes by title or content
     *
     * @param req request object coming from client
     * @param res response object to send to client
     */
    NodeExpressRouter.get("/search", async (req: Request, res: Response) => {
      try {
        ...
        const searchResponse = await this.BackendNodeGateway.search(searchTerm);
